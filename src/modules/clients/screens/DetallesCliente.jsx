    ...
    <div className="modal-overlay">
      <div className="modal-container">
        ...
        <div className="cliente-info">
          ...
          <p>
            <strong>Teléfono principal:</strong> {cliente.telefonos[0] || "No disponible"}
          </p>
          {cliente.telefonos.slice(1).map((telefono, index) => (
            <p key={index}>
              <strong>Teléfono adicional {index + 1}:</strong> {telefono || "No disponible"}
            </p>
          ))}
          <hr />
          ...
          <p>
            <strong>Colonia:</strong> {cliente.colonia}
          </p>
          <p>
